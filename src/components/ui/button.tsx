...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "gradient-primary text-primary-foreground shadow-glow hover:shadow-glow-lg hover:-translate-y-px active:scale-[0.98]",
        destructive:
          "bg-red-500/15 text-red-400 border border-red-500/20 hover:bg-red-500/25 hover:border-red-500/30",
        outline:
          "border border-glass-border bg-transparent hover:bg-glass-30 hover:border-indigo-500/20",
        secondary:
          "bg-glass-20 text-foreground border border-glass-border hover:bg-glass-30 hover:border-indigo-500/15",
        ghost: "hover:bg-glass-20 text-foreground",
